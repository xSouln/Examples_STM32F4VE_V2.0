...
//==============================================================================
//==============================================================================
static FlowDirector_Result SetMotorState(MotorDriverT* driver, MotorDriver_State state)
{
	...
	return FlowDirector_ResultAccept;
}
//==============================================================================
static FlowDirector_Result SetDriverState(MotorDriverT* driver, MotorDriver_State state)
{
	switch((uint8_t)state)
	{
		case MotorDriver_StateEnable:
...
//==============================================================================
static FlowDirector_Result SetLockState(MotorDriverT* driver, MotorDriver_MotorState state)
{
	
	return FlowDirector_ResultAccept;
}
//==============================================================================
static FlowDirector_Result Delay(MotorDriverT* driver, uint32_t ms)
{
	HAL_Delay(ms);
	return FlowDirector_ResultAccept;
}
//==============================================================================
static FlowDirector_Result SetSpeed(MotorDriverT* driver, float speed)
{
...
//==============================================================================
static FlowDirector_Result SetFrequency(MotorDriverT* driver, float frequency)
{
	return FlowDirector_ResultAccept;
}
//==============================================================================
...
//==============================================================================
static FlowDirector_Result SetPosition(MotorDriverT* driver, int position)
{
...
FlowDirector_Result FlowDirector_Init(FlowDirectorT* adapter, void* parent)
{
	...
	return FlowDirector_ResultNullPointer;
}
//==============================================================================
//==============================================================================

...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PA5     ------> TIM2_ETR
    */
    GPIO_InitStruct.Pin = WATER_FLOW_METER_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(WATER_FLOW_METER_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB1     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = CAROUSEL_MOTOR_CH1B0_Pin|CAROUSEL_MOTOR_CH2B1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PD15     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = BREW_MOTOR_CH1_Pin|BREW_MOTOR_CH2_Pin|POD_RELEASE_MOTOR_CH1_Pin|POD_RELEASE_MOTOR_CH2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    GPIO_InitStruct.Pin = FLOW_DIR_MOTOR_CH1_Pin|FLOW_DIR_MOTOR_CH2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA5     ------> TIM2_ETR
    */
    HAL_GPIO_DeInit(WATER_FLOW_METER_GPIO_Port, WATER_FLOW_METER_Pin);

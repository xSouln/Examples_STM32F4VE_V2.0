...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PD2     ------> TIM3_ETR
    */
    GPIO_InitStruct.Pin = BREW_GROUP_FLOW_METER_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(BREW_GROUP_FLOW_METER_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = CAROUSEL_MOTOR_ENCODER_A_Pin|CAROUSEL_MOTOR_ENCODER_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = WS2812_LED_PANEL_Pin|WS2812_CUPS_12_Pin|WS2812_CUPS_34_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PD15     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = BREW_GROUP_MOTOR_PWM1_Pin|BREW_GROUP_MOTOR_PWM2_Pin|SLIDER_MOTOR_PWM1_Pin|SLIDER_MOTOR_PWM2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM5_MspPostInit 0 */
    ...
    PA3     ------> TIM5_CH4
    */
    GPIO_InitStruct.Pin = FLOW_DIR_MOTOR_PWM1_Pin|FLOW_DIR_MOTOR_PWM2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    GPIO_InitStruct.Pin = CAROUSEL_MOTOR_PWM1_Pin|CAROUSEL_MOTOR_PWM2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PD2     ------> TIM3_ETR
    */
    HAL_GPIO_DeInit(BREW_GROUP_FLOW_METER_GPIO_Port, BREW_GROUP_FLOW_METER_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOA, CAROUSEL_MOTOR_ENCODER_A_Pin|CAROUSEL_MOTOR_ENCODER_B_Pin);

 ...
 */ 
//==============================================================================
#ifndef REGISTERS_STM32X1XX_UART_H
#define REGISTERS_STM32X1XX_UART_H
//==============================================================================
#include <stdint.h>
//==============================================================================
typedef union
...
typedef struct
{
  ...
  volatile REG_UART_CR1_T Control_1; //USART Control register 1
  volatile REG_UART_CR2_T Control_2; //USART Control register 2
  volatile REG_UART_CR3_T Control_3; //USART Control register 3
  volatile REG_UART_GTPR_T GTPR; //SART Guard time and prescaler register
  
} REG_UART_REG_T; // For stm32
//==============================================================================
#endif /* REGISTERS_STM32X1XX_UART_H */
